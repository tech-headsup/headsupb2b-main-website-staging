...
export default function WeHaveRaisedFunds() {
    return (
        <div className='ms:mt-10 ll:mt-24 ms:mx-6 t:mx-20 l:mx-20 ll:mx-20 imac:px-44 4k:px-56 mb-10'>
            <div className=''>
            ...
            <div className='flex mt-10 ms:flex-col t:flex-row justify-center' style={{}}>
                <div><Image src={SumitFounderHeadsup} height={600} /></div>
            </div>
